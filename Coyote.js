...
var Coyote = {
	...
	vymax : 70, // max velocity in y
	a : -1,  // Acceleration for jump
    x : 0, // position in x 
    vx : -12,  // velocity in x
    images : { 	left : "img/BanjoGuyRunningLeft.gif", 
				right : "img/BanjoGuyRunning.gif", 
				// whirl : "img/Coyote_whirls.gif",
				jump_right : "img/BanjoGuyJump.gif",
				jump_left : "img/BanjoGuyJumpLeft.gif" 
			},
    $sprites: null,
	width: null,
	init : function( width ) {
